...
<p align="center">
<img src="https://github.com/msztylko/dashboard-prototyping/blob/master/images/dashboard.gif" data-canonical- width="600" height="300" align="center" />
</p>
...
<p align="center">
<img src="https://github.com/msztylko/dashboard-prototyping/blob/master/images/backend.gif" data-canonical- width="500" height="300" align="center" />
</p>
...
<p align="center">
<img src="https://github.com/msztylko/dashboard-prototyping/blob/master/images/dash_frontend.gif" data-canonical- width="600" height="300" align="center" />
</p>
...
def fetch_prices_with_cache(
    ...
    for bucket in buckets:
        ...
        if cached_raw_value is not None:
            ta = TypeAdapter(list[PriceData])
            prices += ta.validate_python(json.loads(cached_raw_value))
            continue
    ...
    return [p for p in prices if start_date <= p.timestamp < end_date]
